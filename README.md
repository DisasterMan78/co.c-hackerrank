...
1. Implementing core features first
2. Ensuring basic functionality works
3. Work on one step at a time, you don't need to complete all steps at once
...
- Format amounts and dates using the provided formatters (see `src/utils/formatters.ts`)
